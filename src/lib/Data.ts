...
class EdgeData extends Data<EdgeData> {
  ...
  public get bend(): number {
    return this.propertyFloat("bend") ?? 0;
  }

  public setBend(bend: number): EdgeData {
    let d = new EdgeData(this);
    if (bend === 0) {
      d = d.unset("bend");
    } else {
      d = d.setProperty("bend", bend);
    }
    return d;
  }

  public get basicBendMode(): boolean {
    return this.property("in-angle") === undefined || this.property("out-angle") === undefined;
  }
  ...
  public reflect(horizontal: boolean): EdgeData {
    if (this.basicBendMode) {
      ...
      let inAngle = this.propertyFloat("in-angle") ?? 0;
      let outAngle = this.propertyFloat("out-angle") ?? 0;
      ...
      return this.setProperty("in-angle", inAngle).setProperty("out-angle", outAngle);
    }
  }
  ...
  public reverse(): EdgeData {
    const d = this.basicBendMode
      ...
      : this.setProperty("in-angle", this.propertyFloat("out-angle") ?? 0).setProperty(
          "out-angle",
          this.propertyFloat("in-angle") ?? 0
        );
...
class StyleData extends Data<StyleData> {
  ...
  public get isEdgeStyle(): boolean {
    return this._kind === "edge";
  }

  public get kind(): StyleKind {
    return this._kind;
  }

  public setKind(kind: StyleKind): StyleData {
  ...
  public equals(other: StyleData): boolean {
    return super.equals(other) && this._name === other._name && this._kind === other._kind;
  }
